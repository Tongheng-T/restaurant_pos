...
<body>
  ...
  <div id="wrapper">
    <div id="receipt-header">
      <br>
      <div class="logo">
        <img src="../resources/images/logo/logo.png" alt="Logo" class="img-fluid">
      </div>
      <h3 id="resturant-name">Tongheng Coffee</h3>
      <p>Address: Dambea - Tboung Khmum Province</p>
      <p>ផ្លូវលេខ 73</p>
      <p>Tel: 0718989726</p>
      <p>Reference Receipt: <strong><?php echo "00".$id ." - "." តុ: ". $table_name ?></strong></p>
        ...
        <tbody>
          ...
          while ($item = $select->fetch_object()) {
            ...
            echo '
                ...
                <td width="55"> ' . $item->saleprice . '</td>
                <td width="65"> ' . $item->saleprice * $item->qty . ' <span >&#x17DB </span></td>
               </tr>
                ';
            $no++;
            $countqty += $item->qty;
