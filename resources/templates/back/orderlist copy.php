        ...
        <div class="card card-warning card-outline">
          ...
          <form action="" method="post" name="">
            ...
            <div class="card-body">
              ...
              $select = query("SELECT sum(total) as grandtotal , sum(subtotal) as stotal, count(invoice_id) as invoice from tbl_invoice where aus='$aus' and updated_at between '$date_1' AND '$date_2' AND saler_id = '$saler_name'");
              confirm($select);
