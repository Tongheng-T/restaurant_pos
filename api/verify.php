...
<head>
    ...
    <meta name="keywords" content="tongheng-t, Tonghengt, tongheng, khmer">
    ...
    <link rel='shortcut icon' href="../../resources/img/logo/logo1.png">
...
<div class="topnav">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 offset-md-4 form"><?php display_messag_signin(); ?>
                <form action="" method="POST" >
                    ...
                    <div class="form-group">
                        <input class="form-control button" type="submit" name="cerify_code" value="Submit">
                    </div>
                </form>
            </div>
        </div>
