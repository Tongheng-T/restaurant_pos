        ...
        <form method="post" action="" name="">
          <div class="card card-primary card-outline">
            ...
            <div class="card-body">
              ...
              $select = query("SELECT updated_at , sum(total) as grandtotal from tbl_invoice where aus='$aus' and updated_at between '$date_1' AND '$date_2' group by updated_at");
              confirm($select);
            ...
            <?php
            $select = query("SELECT product_name , sum(qty) as q from tbl_invoice_details where aus='$aus' and updated_at between '$date_1' AND '$date_2' group by product_id");
            confirm($select);
