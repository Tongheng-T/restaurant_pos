              ...
              <table class="table table-striped table-hover " id="table_orderlist">
                ...
                <tbody>
                  ...
                  while ($row = $select->fetch_object()) {
                    ...
                    <td>
                    <div class="btn-group">
                    <a href="showReceipt?id=' . $row->invoice_id . '" class="btn btn-success" role="button" ><span class="fa fa-print" style="color:#ffffff" data-toggle="tooltip" title="Print Bill"></span></a>
