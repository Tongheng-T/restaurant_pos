        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <label for="exampleInputEmail1">បញ្ចូលលេខយោង<p class="text-danger" style="display: inline-block;">*</p></label>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <img src="logo/qrc/qrcdoe.jpg" onclick="triggerClick_pay()" id="profiledisplay_pay">
                </div>
            </div>
        </div>
    </div>
