                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="txtselect_option" required>
                      ...
                      ?>
                        <option <?php if ($row['catid'] == $category_id_db) { ?> selected="selected" <?php } ?>><?php echo $row['category']; ?></option>
                ...
                <div class="col-md-6">
                  <div class="form-group clearfix">
                    <div class="icheck-danger d-inline">
                      <input type="radio" id="radioPrimary1" name="r1" value="1" <?php echo ($num_category == 1) ? 'checked' : '' ?>>
                      <label for="radioPrimary1">
                        ប្រភេទម្ហូប/ កែវ
                      </label>
                    </div>
                    <div class="icheck-primary d-inline">
                      <input type="radio" id="radioPrimary2" name="r1" value="2" <?php echo ($num_category == 2) ? 'checked' : '' ?>>
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" min="1" step="any" class="form-control" value="<?php echo $saleprice_db; ?>" placeholder="Enter Price" name="txtsaleprice" autocomplete="off" required>
                  </div>
                  <div class="form-group">
                    <label>Size M Price</label>
                    <input type="number" min="0" step="any" class="form-control" value="<?php echo $m_price_db; ?>" placeholder="Enter Price" name="txtm_price" autocomplete="off">
                  </div>
