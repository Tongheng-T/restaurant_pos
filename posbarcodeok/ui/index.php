...
<div class="content-wrapper">
    ...
    if (isset($_GET['productstocklist'])) {

        include(TEMPLATE_BACK . "/productstocklist.php");
    }
    ...
    if (isset($_GET['report_sales_summary'])) {
        include(TEMPLATE_BACK . "/report_sales_summary.php");
    }
    ...
    if (isset($_GET['dashboard_tomley'])) {

        include(TEMPLATE_BACK . "/dashboard_tomley.php");
    }
    if (isset($_GET['table_stocklis'])) {

        include(TEMPLATE_BACK . "/table_stocklis.php");
    }
